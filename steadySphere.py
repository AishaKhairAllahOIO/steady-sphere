...
class ColorTracker:
    ...
    @staticmethod
    def solve_maze(maze_matrix,start,end):
...
lower_center,upper_center=colorTracker.getRangeHSV(center)
...
while True:
    ...
    if not platform_center_locked:
        mask_clean,platform_X,platform_Y=colorTracker.track_rectangle_position(frame,HSV_frame,lower_center,upper_center)
    ...
    if key==ord('q'):
       ...
       print("PID values reset to 0")
        ...
        if maze_img is not None:
            ...
            maze_matrix = colorTracker.maze_to_matrix(maze_img, grid_size=(40,40))
            ...
            print("No valid maze found to crop!", "ERROR")
